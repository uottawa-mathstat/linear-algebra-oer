...
\input{eng/ourmacros}
\input{eng/newmymacroslatexVSF.tex}
...
\noindent \textsc{This document is available at:} \href{https://ruor.uottawa.ca/handle/10393/43430}{https://ruor.uottawa.ca/}\\% Publisher
...
\noindent \textit{Fourth edition, August 2021} % Printing/edition date
...
%\include{eng/00-partalggeo}


\input{eng/01-complex}
\input{eng/01-complex-prob}
\input{eng/02-vectors}
\input{eng/02-vectors-prob}
\input{eng/03-linesplanes}
\input{eng/03-linesplanes-prob}
...
\input{eng/05-defvectorspaces}
\input{eng/05-defvectorspaces-prob}
\input{eng/06-subspaces}
\input{eng/06-subspaces-prob}
\input{eng/07-span}
\input{eng/07-span-prob}
\input{eng/08-linearindependence}
\input{eng/08-linearindependence-prob}
\input{eng/09-consequences}
\input{eng/09-consequences-prob}
\input{eng/10-basisdimension}
\input{eng/10-basisdimension-prob}
\input{eng/11-dimensiontheorems.tex}
\input{eng/11-dimensiontheorems-prob}
...
\input{eng/13-solvingsystems}
\input{eng/13-solvingsystems-prob}
\input{eng/14-solvingsystems}
\input{eng/14-solvingsystems-prob}
\input{eng/15-applications}
\input{eng/15-applications-prob}
\input{eng/16-matrixmult}
\input{eng/16-matrixmult-prob}
\input{eng/17-homogsystems}
\input{eng/17-homogsystems-prob}
\input{eng/18-basiscolnew}
\input{eng/18-basiscolnew-prob}
\input{eng/19-wrapupbases}
\input{eng/19-wrapupbases-prob}
\input{eng/20-inverses}
\input{eng/20-inverses-prob}
...
\input{eng/22-orthogproj}
\input{eng/22-orthogproj-prob}
\input{eng/23-orthogcomp}
\input{eng/23-orthogcomp-prob}
...
\input{eng/25-determinants}
\input{eng/25-determinants-prob}
\input{eng/26-eigensystems}
\input{eng/26-eigensystems-prob}
\input{eng/27-diag}
\input{eng/27-diag-prob}
...
%\input{eng/28-partlineartransformations}
\input{eng/29-lineartransformations}
\input{eng/29-lineartransformations-prob}
